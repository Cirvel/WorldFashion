   ...
   <nav class="navbar navbar-dark bg-dark">
    ...
    <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasMenu" aria-labelledby="offcanvasMenuLabel">
        ...
        <div class="offcanvas-body background_sidebar_color">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <b><h6><a class="nav-link active" aria-current="page" href="{{ route('dashboard.main') }}">Home</a></h6></b>
                </li>
                <li class="nav-item">
                    <b><h6><a class="nav-link" href="{{ route('dashboard.former') }}">Former events</a></h6></b>
                </li>
            </ul>
    ...
    <div class="container">
        <div class="row mt-3 mb-5">
            <div class="col-4">
                <video class="video-bg img-fluid" controls>
                    <source src="{{ asset('video/smallvid1.mp4') }}" type="video/mp4">
                </video>
            </div>
            <div class="col-4">
                <video class="video-bg img-fluid" controls>
                    <source src="{{ asset('video/smallvid2.mp4') }}" type="video/mp4">
                </video>
            </div>
            <div class="col-4">
                <video class="video-bg img-fluid" controls>
                    <source src="{{ asset('video/smallvid3.mp4') }}" type="video/mp4">
                </video>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div id="countdown" class="row text-center d-flex justify-content-center">
            <div class="col-2">
                <h1>-</h1>
                <h3>Days</h3>
            </div>
                ...
                <div class="col-lg-6 mb-3">
                    ...
                    <div class="row">
                        <div class="col-lg-6 mb-3">
                            ...
                            <ul class="list-unstyled">
                                <li><a href="{{ route('dashboard.admin') }}" class="cw">Franchise</a></li>
                            </ul>
                        </div>
                        <div class="col-lg-6 mb-3">
